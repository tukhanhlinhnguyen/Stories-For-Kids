...
import { SVGToastSanitizePipe } from './svg-toast-sanitize-pipe';
...
// sanitizer.bypassSecurityTrustHtml(
  // 
    ...
    <div class="row" [style.display]="state.value === 'inactive' ? 'none' : ''">
      <div class="col-9">
        ...
        <div  role="alert" aria-live="polite" *ngIf="options.enableHtml"
  ...
  export class SVGToast extends Toast {
